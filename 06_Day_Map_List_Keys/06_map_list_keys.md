<div align="center">
  ...
  <a class="header-badge" tarconst Header = (props) => {
  const data = props.data
  const { welcome, title, subtitle, author, date } = dataconst Header = (props) => {
  const data = props.data
  const { welcome, title, subtitle, author, date } = dataget="_blank" href="https://twitter.com/Asabeneh">
